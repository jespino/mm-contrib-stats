...
python main.py contributors --token $GITHUB_TOKEN --org mattermost --repo desktop --repo mattermost-redux --repo mattermost-webapp --repo mattermost-server --repo mattermost-mobile --json > contributions.json
